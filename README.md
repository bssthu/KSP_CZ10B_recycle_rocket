...
- 回收段在 30 km 建立一次高度索引轨迹，13.5 km 内切入距离索引停车走廊；2 km 门限要求垂直速度不超过 200 m/s、横速不超过 12 m/s且水平误差不超过 50 m，进入中心 10 m 后的回摆不得超过 30 m。常规制动限制为 75% 最大推力，总矢量权限为 98%；地面相对速度不低于 30 m/s 时，喷管轴与速度夹角不超过 30°。
- 四索在挂钩首次进入 100 m 触发区后锁存目标，开口按挂钩高度线性缩小，并在网面上方 1 m 达到最终尺寸；短时横摆不会让索重新打开。
- 2026-07-14 的最终完整海上实机已在静音、KSC 当地 06:00 条件下通过 `SEA_MISSION_TEST_PASS`：一级约在 49 km、余量 19.94% 时分离，二级进入 107.690 × 90.495 km 轨道；2 km 门限为垂直 143.82 m/s、横向 15.48 m/s、误差 2.4 m，受约束高速段最大喷管/速度夹角 13.16°。一级最终以垂直 −2.48 m/s、横向 0.54 m/s、倾角 0.2° 四点捕获，拉索连续放缆到 11.92 m，平台倾斜 0.04°，稳定窗口连续超过 8 秒，着网余量 0.43%。
