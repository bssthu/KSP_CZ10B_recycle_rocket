...
8. 30 km 是固定高度索引轨迹的测量与规划交接点；常规垂直制动只使用最大推力的 75%，总矢量权限限制为 98%，地面相对速度不低于 30 m/s 时喷管轴与速度夹角不超过 30°。13.5 km 内切入距离索引停车走廊，目标是在 2 km 门限前达到垂直不超过 200 m/s、横速不超过 12 m/s且水平误差不超过 50 m；5 km 以下首次进入中心 10 m 后的回摆不得超过 30 m。300 m 内锁存慢速阻尼，65 m 内边下降边完成最终对准；500 m 以下的横向修正不再额外抬升垂直推力，避免低空向上跳升。
...
2026-07-14 最终复验在 2 km 记录垂直 104.86 m/s、水平 3.05 m/s、误差 18.9 m，整个高速受约束段最大喷管/速度夹角 16.28°；5 km 以下首次进入中心 10 m 后的最大回摆为 25.3 m。捕获为垂直 −4.00 m/s、水平 0.33 m/s、倾角 4.5°，放绳稳定到 11.92 m，平台倾斜 0.04°。
